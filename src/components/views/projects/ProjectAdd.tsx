...
const ProjectAdd: React.FC = () => {
  ...
  // * APOLLO MUTATION
  const [createProject, { data: projectData, loading: projectLoading, error: projectError }] = useMutation(CREATE_PROJECT);
  ...
  useEffect(() => {
    if (!customersData) {
      ...
      setCustomerList(customersData.getAllCustomers.data)
    };
