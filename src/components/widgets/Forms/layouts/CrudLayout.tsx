...
import { EButtonSize, EButtonVariant, ECrudActionType, ETextSize } from '@/components/types/props/enum';
    ...
    <div className="CrudLayout / w-full bg-white dark:bg-gray-800 rounded / border-b-4 border-dark dark:border-white / focus-within:shadow-md shadow px-4 lg:px-8 pt-4">
      <div className="CrudLayout_header / flex items-center pb-4">
        <div className="crudLayout_headerTitles / w-7/12 / flex flex-col">
          <HeadingTitle textSize={ETextSize.x2} customclass="font-bold text-dark dark:text-white">
            {headingText}
          </HeadingTitle>
          <HeadingTitle textSize={ETextSize.sm} customclass="font-semibold text-gray-400">
            {subHeadingText}
          </HeadingTitle>
        </div>
